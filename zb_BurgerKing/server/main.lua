...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'burgerking', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'burgerking', _U('burgerking_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'burgerking', 'burgerking', 'society_burgerking', 'society_burgerking', 'society_burgerking', {type = 'private'})
...
RegisterServerEvent('esx_burgerking:startHarvest')
AddEventHandler('esx_burgerking:startHarvest', function(zone)
...
RegisterServerEvent('esx_burgerking:stopHarvest')
AddEventHandler('esx_burgerking:stopHarvest', function()
  local _source = source
...
RegisterServerEvent('esx_burgerking:startTransform')
AddEventHandler('esx_burgerking:startTransform', function(zone)
  local _source = source
...
RegisterServerEvent('esx_burgerking:stopTransform')
AddEventHandler('esx_burgerking:stopTransform', function()
  local _source = source
      ...
      if xPlayer.getInventoryItem('sachetketchup').count <= 0 then
        ...
        if (ketchup == 1) then
          SetTimeout(1100, function()
            ...
            TriggerEvent('esx_addonaccount:getSharedAccount', 'society_burgerking', function(account)
...
RegisterServerEvent('esx_burgerking:startSell')
AddEventHandler('esx_burgerking:startSell', function(zone)
  local _source = source
...
RegisterServerEvent('esx_burgerking:stopSell')
AddEventHandler('esx_burgerking:stopSell', function()
  local _source = source
...
RegisterServerEvent('esx_burgerking:getStockItem')
AddEventHandler('esx_burgerking:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_burgerking', function(inventory)
...
ESX.RegisterServerCallback('esx_burgerking:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_burgerking:putStockItems')
AddEventHandler('esx_burgerking:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_burgerking:getFridgeStockItem')
AddEventHandler('esx_burgerking:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_burgerking_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_burgerking:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_burgerking:putFridgeStockItems')
AddEventHandler('esx_burgerking:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_burgerking:buyItem')
AddEventHandler('esx_burgerking:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_burgerking:ingredientgBurger')
AddEventHandler('esx_burgerking:ingredientgBurger', function(itemValue)
...
RegisterServerEvent('esx_burgerking:craftingBurger')
AddEventHandler('esx_burgerking:craftingBurger', function(itemValue)
...
ESX.RegisterServerCallback('esx_burgerking:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_burgerking', function(store)
...
ESX.RegisterServerCallback('esx_burgerking:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_burgerking:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_burgerking:getPlayerInventory', function(source, cb)
