Locales['fr'] = {
    ...
    ['burgerking_outfit']        = 'Tenue BurgerKing',
    ...
    ['burgerking_fridge_stock']     = 'Frigo du BurgerKing',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du BurgerKing',
    ...
    ['burgerking_stock']            = 'Stock du burgerking',
    ...
    -- Misc  
    ['map_blip']                 = '~r~Burger ~y~King',
    ['burgerking']               = '~r~Burger ~y~King',

    -- Phone  
    ['burgerking_phone']            = 'Burger King',
    ['burgerking_customer']         = 'Citoyen',
    ...
    -- Run
  ['burgerking_client'] = 'client BurgerKing',
