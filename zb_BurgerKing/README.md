Ce script permet d'avoir le job Burger King sur son serveur gta 5 RP (fivem).
...
2) Ouvrez l'archive "esx_burgerking"
3) Placer le dossier "esx_burgerking" dans /[esx]
4) Importer esx_burgerking.sql dans votre base de donnée
5) Ajouter cette ligne dans votre server.cfg : ensure esx_burgerking

# Legal

Copyright (C) 2022 ZeBee
