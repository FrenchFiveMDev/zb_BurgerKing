AddEventHandler("onResourceStart", function(name)
  if name == GetCurrentResourceName() then
      print("[^5Auteur^7] : ZeBee")
      print("[^2Version^7] : Version 1.0.0")
      print("[^3Description^7] : zb_cbdshop")
  end
end)
...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'burgerking' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'burgerking_outfit' then
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('burgerking_outfit'),    value = 'burgerking_outfit'},
  }
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'burgerking_outfit' then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'burgerking', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'burgerking_actions',
    {
      title    = _U('burgerking'),
      align    = 'top-left',
      elements = elements
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('esx_burgerking:craftingBurger', data2.current.value)
       ...
       if data.current.value == 'menu_ingredient' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu3)
                ...
                TriggerServerEvent('esx_burgerking:ingredientgBurger', data2.current.value)
                animsAction({ lib = "mini@drinking", anim = "shots_barman_b" })
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_burgerking', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_burgerking:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_burgerking:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_burgerking:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_burgerking:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_burgerking:getFridgeStockItems', function(items)
    ...
    ESX.UI.Menu.Open(
      ...
      {
        title    = _U('burgerking_fridge_stock'),
        elements = elements
      },
      function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_burgerking:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_burgerking:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_burgerking:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_burgerking:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_burgerking:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'burgerking_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_burgerking:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_burgerking:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_burgerking:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_burgerking:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_burgerking:hasExitedMarker', LastZone)
            end
...
AddEventHandler('esx_burgerking:hasExitedMarker', function(zone)
  ESX.UI.Menu.CloseAll()
  if (zone == 'KetchupFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'burgerking' then
    TriggerServerEvent('esx_burgerking:stopHarvest')
  end  
  if (zone == 'SachetKetchup') and PlayerData.job ~= nil and PlayerData.job.name == 'burgerking' then
    TriggerServerEvent('esx_burgerking:stopTransform')
  end
  if (zone == 'SellFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'burgerking' then
    TriggerServerEvent('esx_burgerking:stopSell')
  end
  CurrentAction = nil
end)
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'ketchup_harvest' then
          TriggerServerEvent('esx_burgerking:startHarvest', CurrentActionData.zone)
        end
        if CurrentAction == 'ketchup_sachet' then
          TriggerServerEvent('esx_burgerking:startTransform', CurrentActionData.zone)
        end
        if CurrentAction == 'farm_resell' then
          TriggerServerEvent('esx_burgerking:startSell', CurrentActionData.zone)
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'burgerking', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'burgerking')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'burgerking', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'burgerking_actions') then
